...
- Plaid API key
- Google Gemini API
- Mistral local model (a higher number of parameters, as much as your hardware can handle)
- Todoist account & API
- More to be added.
